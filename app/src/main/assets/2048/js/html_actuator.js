function HTMLActuator() {
    ...
    this.aiButton = document.querySelector(".ai-container");
    this.aiTip = document.querySelector("#aiTip");
...
HTMLActuator.prototype.updateAiTip = function (tip) {
    this.aiTip.innerHTML = tip;
};
