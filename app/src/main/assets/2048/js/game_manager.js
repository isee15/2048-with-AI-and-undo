...
GameManager.prototype.gridToJson = function () {
    var self = this;
...
GameManager.prototype.run = function () {
    this.actuator.updateAiTip('AI 思考中');
    var best = window.external.execute("getbest", "{'grid':'" + this.gridToJson() + "'}");
    this.actuator.updateAiTip('');
    window.external.execute("log", best);
    ...
    } else if (this.running && this.isGameTerminated()) {
        this.ai();
    }
}
